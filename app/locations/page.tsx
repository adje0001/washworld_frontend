...
export default function Locations() {
  ...
  return (
    <div>
      {/* Page header */}
      <section className="bg-white px-4 pt-10 pb-8 text-center">
        ...
        <p className="text-gray-500 text-sm">Få ubegrænset adgang til <span className="font-bold text-gray-800">alle vaskehaller</span> for +10 kr./md.</p>
      </section>
      ...
      <div className="px-4 pb-8">
        <div className="max-w-6xl mx-auto">
          ...
          {filtered?.length === 0 && (
            <p className="text-gray-500 text-sm py-8 text-center">Ingen vaskehaller matcher din søgning.</p>
          )}
